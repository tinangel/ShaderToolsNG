...
def ApiKeys():
    temp = \
        (      
         ...
         "texture_image_use_auto_refresh",  "texture_image_use_cyclic", "texture_environment_map_zoom", "material_index")
    return temp
#end Api keys
#Langages keys
def LangagesKeys():
...
def TexturesPropertiesKeys(api_functions):
    temp  = {"texture_coords":(api_functions['texture_coords'],  ''), "mapping":(api_functions['mapping'],  ''), "mapping_x":(api_functions['mapping_x'],  ''), 
        ...
        "bump_objectspace":(api_functions['bump_objectspace'],  ''), "texture_use_color_ramp":(api_functions['texture_use_color_ramp'],  ''), 
        "texture_factor_red":(api_functions['texture_factor_red'],  ''), "texture_factor_green":(api_functions['texture_factor_green'],  ''), 
        "texture_factor_blue":(api_functions['texture_factor_blue'],  ''), "texture_intensity":(api_functions['texture_intensity'],  ''), 
        "texture_contrast":(api_functions['texture_contrast'],  ''), "texture_saturation":(api_functions['texture_saturation'],  ''), 
        "texture_factor_blue":(api_functions['texture_factor_blue'],  ''), "texture_progression":(api_functions['texture_progression'],  ''), 
        "texture_use_flip_axis":(api_functions['texture_use_flip_axis'],  ''), "texture_cloud_type":(api_functions['texture_cloud_type'],  ''), 
        "texture_noise_type":(api_functions['texture_noise_type'],  ''), "texture_noise_basis":(api_functions['texture_noise_basis'],  ''), 
        "texture_noise_scale":(api_functions['texture_noise_scale'],  ''), "texture_nabla":(api_functions['texture_nabla'],  ''), 
        "texture_noise_depth":(api_functions['texture_noise_depth'],  ''), "texture_noise_distortion":(api_functions['texture_noise_distortion'],  ''), 
        "texture_noise_basis":(api_functions['texture_noise_basis'],  ''), "texture_distortion":(api_functions['texture_distortion'],  ''), 
        "texture_nabla":(api_functions['texture_nabla'],  ''), "texture_noise_scale":(api_functions['texture_noise_scale'],  ''), 
        "texture_noise_depth":(api_functions['texture_noise_depth'],  ''), "texture_turbulence":(api_functions['texture_turbulence'],  ''), 
        "texture_marble_type":(api_functions['texture_marble_type'],  ''), "texture_noise_scale_2":(api_functions['texture_noise_scale_2'],  ''),  
        "texture_noise_type":(api_functions['texture_noise_type'],  ''), "texture_noise_basis":(api_functions['texture_noise_basis'],  ''), 
        "texture_noise_scale":(api_functions['texture_noise_scale'],  ''), "texture_noise_depth":(api_functions['texture_noise_depth'],  ''), 
        "texture_nabla":(api_functions['texture_nabla'],  ''), "texture_turbulence":(api_functions['texture_turbulence'],  ''), 
        "texture_noise_basis":(api_functions['texture_noise_basis'],  ''), "texture_noise_scale":(api_functions['texture_noise_scale'],  ''), 
        "texture_nabla":(api_functions['texture_nabla'],  ''), "texture_musgrave_type":(api_functions['texture_musgrave_type'],  ''), 
        "texture_dimension_max":(api_functions['texture_dimension_max'],  ''), "texture_lacunarity":(api_functions['texture_lacunarity'],  ''), 
        "texture_octaves":(api_functions['texture_octaves'],  ''), "texture_offset":(api_functions['texture_offset'],  ''), 
        "texture_noise_intensity":(api_functions['texture_noise_intensity'],  ''), "texture_gain":(api_functions['texture_gain'],  ''),
        "texture_stucci_type":(api_functions['texture_stucci_type'],  ''), "texture_noise_type":(api_functions['texture_noise_type'],  ''), 
        "texture_noise_basis":(api_functions['texture_noise_basis'],  ''), "texture_noise_scale":(api_functions['texture_noise_scale'],  ''), 
        "texture_turbulence":(api_functions['texture_turbulence'],  ''),"texture_distance_metric":(api_functions['texture_distance_metric'],  ''), 
        "texture_minkovsky_exponent":(api_functions['texture_minkovsky_exponent'],  ''), "texture_color_mode":(api_functions['texture_color_mode'],  ''), 
        "texture_noise_intensity":(api_functions['texture_noise_intensity'],  ''), "texture_noise_scale":(api_functions['texture_noise_scale'],  ''), 
        "texture_nabla":(api_functions['texture_nabla'],  ''), "texture_weight_1":(api_functions['texture_weight_1'],  ''), 
        "texture_weight_2":(api_functions['texture_weight_2'],  ''), "texture_weight_3":(api_functions['texture_weight_3'],  ''), 
        "texture_weight_4":(api_functions['texture_weight_4'],  ''), "texture_noise_basis_2":(api_functions['texture_noise_basis_2'],  ''), 
        "texture_wood_type":(api_functions['texture_wood_type'],  ''), "texture_noise_type":(api_functions['texture_noise_type'],  ''), 
        "texture_noise_basis":(api_functions['texture_noise_basis'],  ''), "texture_noise_scale":(api_functions['texture_noise_scale'],  ''), 
        "texture_nabla":(api_functions['texture_nabla'],  ''), "texture_turbulence":(api_functions['texture_turbulence'],  ''),
        "texture_point_density_use_turbulence":(api_functions['texture_point_density_use_turbulence'],  ''), 
        "texture_point_density_turbulence_influence":(api_functions['texture_point_density_turbulence_influence'],  ''), 
        "texture_noise_basis":(api_functions['texture_noise_basis'],  ''), 
        "texture_point_density_turbulence_scale":(api_functions['texture_point_density_turbulence_scale'],  ''),
        "texture_point_density_turbulence_depth":(api_functions['texture_point_density_turbulence_depth'],  ''), 
        "texture_point_density_turbulence_strength":(api_functions['texture_point_density_turbulence_strength'],  ''), 
        "texture_point_density_point_source":(api_functions['texture_point_density_point_source'],  ''), 
        "texture_point_density_particle_cache_space":(api_functions['texture_point_density_particle_cache_space'],  ''),
        "texture_point_density_speed_scale":(api_functions['texture_point_density_speed_scale'],  ''), 
        "texture_point_density_color_source":(api_functions['texture_point_density_color_source'],  ''),
        "texture_point_density_radius":(api_functions['texture_point_density_radius'],  ''), 
        "texture_point_density_falloff":(api_functions['texture_point_density_falloff'],  ''), 
        "texture_point_density_use_falloff_curve":(api_functions['texture_point_density_use_falloff_curve'],  ''), 
        "texture_point_density_vertex_cache_space":(api_functions['texture_point_density_vertex_cache_space'],  ''), 
        "texture_point_density_falloff_speed_scale":(api_functions['texture_point_density_falloff_speed_scale'],  ''),
        "texture_extension":(api_functions['texture_extension'],  ''), "texture_crop_min_x":(api_functions['texture_crop_min_x'],  ''), 
        "texture_crop_min_y":(api_functions['texture_crop_min_y'],  ''), "texture_crop_max_x":(api_functions['texture_crop_max_x'],  ''),
        "texture_crop_max_y":(api_functions['texture_crop_max_y'],  ''), "texture_repeat_x":(api_functions['texture_repeat_x'],  ''), 
        "texture_repeat_y":(api_functions['texture_repeat_y'],  ''), "texture_use_mirror_x":(api_functions['texture_use_mirror_x'],  ''),
        "texture_use_mirror_y":(api_functions['texture_use_mirror_y'],  ''), "texture_use_checker_even":(api_functions['texture_use_checker_even'],  ''), 
        "texture_use_checker_odd":(api_functions['texture_use_checker_odd'],  ''), "texture_checker_distance":(api_functions['texture_checker_distance'],  ''), 
        "texture_use_alpha":(api_functions['texture_use_alpha'],  ''), "texture_use_calculate_alpha":(api_functions['texture_use_calculate_alpha'],  ''), 
        "texture_invert_alpha":(api_functions['texture_invert_alpha'],  ''), "texture_use_flip_axis":(api_functions['texture_use_flip_axis'],  ''), 
        "texture_use_normal_map":(api_functions['texture_use_normal_map'],  ''),"texture_normal_map_space":(api_functions['texture_normal_map_space'],  ''), 
        "texture_use_derivative_map":(api_functions['texture_use_derivative_map'],  ''), "texture_use_mipmap":(api_functions['texture_use_mipmap'],  ''), 
        "texture_use_mipmap_gauss":(api_functions['texture_use_mipmap_gauss'],  ''), 
        "texture_use_interpolation":(api_functions['texture_use_interpolation'],  ''), "texture_filter_type":(api_functions['texture_filter_type'],  ''),
        "texture_filter_eccentricity":(api_functions['texture_filter_eccentricity'],  ''), "texture_filter_size":(api_functions['texture_filter_size'],  ''), 
        "texture_filter_probes":(api_functions['texture_filter_probes'],  ''), "texture_use_filter_size_min":(api_functions['texture_use_filter_size_min'],  ''), 
        "texture_image_source":(api_functions['texture_image_source'],  ''), "texture_image_generated_width":(api_functions['texture_image_generated_width'],  ''), 
        "texture_image_generated_height":(api_functions['texture_image_generated_height'],  ''), 
        "texture_image_generated_float":(api_functions['texture_image_generated_float'],  ''),
        "texture_image_generated_type":(api_functions['texture_image_generated_type'],  ''), 
        "texture_image_use_fields":(api_functions['texture_image_use_fields'],  ''), 
        "texture_image_use_premultiply":(api_functions['texture_image_use_premultiply'],  ''), 
        "texture_image_field_order":(api_functions['texture_image_field_order'],  ''), 
        "texture_image_frame_duration":(api_functions['texture_image_frame_duration'],  ''), 
        "texture_image_frame_start":(api_functions['texture_image_frame_start'],  ''), 
        "texture_image_frame_offset":(api_functions['texture_image_frame_offset'],  ''), 
        "texture_image_fields_per_frame":(api_functions['texture_image_fields_per_frame'],  ''), 
        "texture_image_use_auto_refresh":(api_functions['texture_image_use_auto_refresh'],  ''), 
        "texture_image_use_cyclic":(api_functions['texture_image_use_cyclic'],  ''), "texture_filter_type":(api_functions['texture_filter_type'],  ''), 
        "texture_filter_eccentricity":(api_functions['texture_filter_eccentricity'],  ''), "texture_filter_size":(api_functions['texture_filter_size'],  ''), 
        "texture_use_filter_size_min":(api_functions['texture_use_filter_size_min'],  ''), "texture_filter_probes":(api_functions['texture_filter_probes'],  ''), 
        "texture_environment_map_source":(api_functions['texture_environment_map_source'],  ''), 
        "texture_environment_map_zoom":(api_functions['texture_environment_map_zoom'],  ''), 
        "texture_environment_map_layers_ignore":(api_functions['texture_environment_map_layers_ignore'],  ''), 
        "texture_environment_map_resolution":(api_functions['texture_environment_map_resolution'],  ''), 
        "texture_environment_map_depth":(api_functions['texture_environment_map_depth'],  ''), 
        "texture_environment_map_clip_start":(api_functions['texture_environment_map_clip_start'],  ''), 
        "texture_environment_map_clip_end":(api_functions['texture_environment_map_clip_end'],  ''), 
        "texture_environment_map_mapping":(api_functions['texture_environment_map_mapping'],  ''),
        "texture_voxel_data_file_format":(api_functions['texture_voxel_data_file_format'],  ''), 
        "texture_voxel_data_intensity":(api_functions['texture_voxel_data_intensity'],  ''), 
        "texture_voxel_data_extension":(api_functions['texture_voxel_data_extension'],  ''), 
        "texture_voxel_data_interpolation":(api_functions['texture_voxel_data_interpolation'],  ''), 
        "texture_voxel_data_smoke_data_type":(api_functions['texture_voxel_data_smoke_data_type'],  ''), 
        "texture_voxel_data_filepath":(api_functions['texture_voxel_data_filepath'],  ''), 
        "texture_voxel_data_resolution":(api_functions['texture_voxel_data_resolution'],  ''), 
        "texture_voxel_data_use_still_frame":(api_functions['texture_voxel_data_use_still_frame'],  ''),
        "texture_voxel_data_still_frame":(api_functions['texture_voxel_data_still_frame'],  ''),}
    return temp    

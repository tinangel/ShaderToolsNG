...
def TexturesPropertiesKeys(api_functions):
    temp  = {"texture_coords":(api_functions['texture_coords'],  ''), "mapping":(api_functions['mapping'],  ''), "mapping_x":(api_functions['mapping_x'],  ''), 
        ...
        "texture.progression":(api_functions['texture_progression'],  'yes'), 
        "texture.use_flip_axis":(api_functions['texture_use_flip_axis'],  ''), "texture.cloud_type":(api_functions['texture_cloud_type'],  'yes'), 
        "texture.noise_type":(api_functions['texture_noise_type'],  'yes'), "texture.noise_scale":(api_functions['texture_noise_scale'],  ''), 
        "texture.noise_depth":(api_functions['texture_noise_depth'],  ''), "texture.noise_distortion":(api_functions['texture_noise_distortion'],  ''), 
        "texture.noise_basis":(api_functions['texture_noise_basis'],  'yes'), "texture_distortion":(api_functions['texture_distortion'],  ''), 
        "texture.nabla":(api_functions['texture_nabla'],  ''), 
        "texture.turbulence":(api_functions['texture_turbulence'],  ''), 
        "texture.marble_type":(api_functions['texture_marble_type'],  ''), "texture.noise_scale_2":(api_functions['texture_noise_scale_2'],  'yes'),  
        "texture.musgrave_type":(api_functions['texture_musgrave_type'],  'yes'), 
        ...
        "texture.stucci_type":(api_functions['texture_stucci_type'],  'yes'),
        "texture.distance_metric":(api_functions['texture_distance_metric'],  'yes'), 
        "texture.minkovsky_exponent":(api_functions['texture_minkovsky_exponent'],  ''), "texture.color_mode":(api_functions['texture_color_mode'],  'yes'), 
        ...
        "texture.weight_4":(api_functions['texture_weight_4'],  ''), "texture.noise_basis_2":(api_functions['texture_noise_basis_2'],  'yes'), 
        "texture.wood_type":(api_functions['texture_wood_type'],  'yes'),  
        ...
        "texture.invert_alpha":(api_functions['texture_invert_alpha'],  ''),  
        "texture.use_normal_map":(api_functions['texture_use_normal_map'],  ''),"texture.normal_map_space":(api_functions['texture_normal_map_space'],  ''), 
        ...
        "texture.image.source":(api_functions['texture_image_source'],  'yes'), "texture.image.generated_width":(api_functions['texture_image_generated_width'],  ''), 
        ...
        "texture.image.frame_duration":(api_functions['texture_image_frame_duration'],  ''), 
        "texture.image.frame_start":(api_functions['texture_image_frame_start'],  ''), 
        "texture.image.frame_offset":(api_functions['texture_image_frame_offset'],  ''), 
        "texture.image.fields_per_frame":(api_functions['texture_image_fields_per_frame'],  ''), 
        "texture.image.use_auto_refresh":(api_functions['texture_image_use_auto_refresh'],  ''), 
        "texture.image.use_cyclic":(api_functions['texture_image_use_cyclic'],  ''), "texture.filter_type":(api_functions['texture_filter_type'],  ''), 
        "texture.filter_eccentricity":(api_functions['texture_filter_eccentricity'],  ''), "texture.filter_size":(api_functions['texture_filter_size'],  ''), 
        ...
        "texture.voxel_data.file_format":(api_functions['texture_voxel_data_file_format'],  'yes'), 
        "texture.voxel_data.intensity":(api_functions['texture_voxel_data_intensity'],  ''), 
        "texture.voxel_data.extension":(api_functions['texture_voxel_data_extension'],  'yes'), 
        "texture.voxel_data.interpolation":(api_functions['texture_voxel_data_interpolation'],  'yes'), 
        "texture.voxel_data.smoke_data_type":(api_functions['texture_voxel_data_smoke_data_type'],  ''), 
        "texture.voxel_data.filepath":(api_functions['texture_voxel_data_filepath'],  'yes'), 
        "texture.voxel_data.resolution":(api_functions['texture_voxel_data_resolution'],  'yes'), 

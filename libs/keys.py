...
def TexturesPropertiesKeys(api_functions):
    temp  = {"texture_coords":(api_functions['texture_coords'],  ''), "mapping":(api_functions['mapping'],  ''), "mapping_x":(api_functions['mapping_x'],  ''), 
        ...
        "blend_type":(api_functions['blend_type'],  ''), "use_rgb_to_intensity":(api_functions['use_rgb_to_intensity'],  ''), 
        ...
        "bump_objectspace":(api_functions['bump_objectspace'],  ''), "texture.use_color_ramp":(api_functions[''],  'texture.use_color_ramp'), 
        "texture.factor_red":(api_functions['texture.factor_red'],  ''), "texture.factor_green":(api_functions['texture.factor_green'],  ''), 
        "texture.factor_blue":(api_functions['texture.factor_blue'],  ''), "texture.intensity":(api_functions['texture.intensity'],  ''), 
        "texture.contrast":(api_functions['texture.contrast'],  ''), "texture.saturation":(api_functions['texture.saturation'],  ''), 
        "texture.factor_blue":(api_functions['texture.factor_blue'],  ''), "texture.progression":(api_functions['texture.progression'],  ''), 
        "texture.use_flip_axis":(api_functions['texture.use_flip_axis'],  ''), "texture.cloud_type":(api_functions['texture.cloud_type'],  ''), 
        "texture.noise_type":(api_functions['texture.noise_type'],  ''), "texture.noise_basis":(api_functions['texture.noise_basis'],  ''), 
        "texture.noise_scale":(api_functions['texture.noise_scale'],  ''), "texture.nabla":(api_functions['texture.nabla'],  ''), 
        "texture.noise_depth":(api_functions['texture.noise_depth'],  ''), "texture.noise_distortion":(api_functions['texture.noise_distortion'],  ''), 
        "texture.noise_basis":(api_functions['texture.noise_basis'],  ''), "texture_distortion":(api_functions['texture_distortion'],  ''), 
        "texture.nabla":(api_functions['texture.nabla'],  ''), "texture.noise_scale":(api_functions['texture.noise_scale'],  ''), 
        "texture.noise_depth":(api_functions['texture.noise_depth'],  ''), "texture.turbulence":(api_functions['texture.turbulence'],  ''), 
        "texture.marble_type":(api_functions['texture.marble_type'],  ''), "texture.noise_scale_2":(api_functions['texture.noise_scale_2'],  ''),  
        "texture.noise_type":(api_functions['texture.noise_type'],  ''), "texture.noise_basis":(api_functions['texture.noise_basis'],  ''), 
        "texture.noise_scale":(api_functions['texture.noise_scale'],  ''), "texture.noise_depth":(api_functions['texture.noise_depth'],  ''), 
        "texture.nabla":(api_functions['texture.nabla'],  ''), "texture.turbulence":(api_functions['texture.turbulence'],  ''), 
        "texture.noise_basis":(api_functions['texture.noise_basis'],  ''), "texture.noise_scale":(api_functions['texture.noise_scale'],  ''), 
        "texture.nabla":(api_functions['texture.nabla'],  ''), "texture.musgrave_type":(api_functions['texture.musgrave_type'],  ''), 
        "texture.dimension_max":(api_functions['texture.dimension_max'],  ''), "texture.lacunarity":(api_functions['texture.lacunarity'],  ''), 
        "texture.octaves":(api_functions['texture.octaves'],  ''), "texture.offset":(api_functions['texture.offset'],  ''), 
        "texture.noise_intensity":(api_functions['texture.noise_intensity'],  ''), "texture.gain":(api_functions['texture.gain'],  ''),
        "texture.stucci_type":(api_functions['texture.stucci_type'],  ''), "texture.noise_type":(api_functions['texture.noise_type'],  ''), 
        "texture.noise_basis":(api_functions['texture.noise_basis'],  ''), "texture.noise_scale":(api_functions['texture.noise_scale'],  ''), 
        "texture.turbulence":(api_functions['texture.turbulence'],  ''),"texture.distance_metric":(api_functions['texture.distance_metric'],  ''), 
        "texture.minkovsky_exponent":(api_functions['texture.minkovsky_exponent'],  ''), "texture.color_mode":(api_functions['texture.color_mode'],  ''), 
        "texture.noise_intensity":(api_functions['texture.noise_intensity'],  ''), "texture.noise_scale":(api_functions['texture.noise_scale'],  ''), 
        "texture.nabla":(api_functions['texture.nabla'],  ''), "texture.weight_1":(api_functions['texture.weight_1'],  ''), 
        "texture.weight_2":(api_functions['texture.weight_2'],  ''), "texture.weight_3":(api_functions['texture.weight_3'],  ''), 
        "texture.weight_4":(api_functions['texture.weight_4'],  ''), "texture.noise_basis_2":(api_functions['texture.noise_basis_2'],  ''), 
        "texture.wood_type":(api_functions['texture.wood_type'],  ''), "texture.noise_type":(api_functions['texture.noise_type'],  ''), 
        "texture.noise_basis":(api_functions['texture.noise_basis'],  ''), "texture.noise_scale":(api_functions['texture.noise_scale'],  ''), 
        "texture.nabla":(api_functions['texture.nabla'],  ''), "texture.turbulence":(api_functions['texture.turbulence'],  ''),
        "texture.point_density.use_turbulence":(api_functions['texture.point_density.use_turbulence'],  ''), 
        "texture.point_density.turbulence_influence":(api_functions['texture.point_density.turbulence_influence'],  ''), 
        "texture.noise_basis":(api_functions['texture.noise_basis'],  ''), 
        "texture.point_density.turbulence_scale":(api_functions['texture.point_density.turbulence_scale'],  ''),
        "texture.point_density.turbulence_depth":(api_functions['texture.point_density.turbulence_depth'],  ''), 
        "texture.point_density.turbulence_strength":(api_functions['texture.point_density.turbulence_strength'],  ''), 
        "texture.point_density.point_source":(api_functions['texture.point_density.point_source'],  ''), 
        "texture.point_density.particle_cache_space":(api_functions['texture.point_density.particle_cache_space'],  ''),
        "texture.point_density.speed_scale":(api_functions['texture.point_density.speed_scale'],  ''), 
        "texture.point_density.color_source":(api_functions['texture.point_density.color_source'],  ''),
        "texture.point_density.radius":(api_functions['texture.point_density.radius'],  ''), 
        "texture.point_density.falloff":(api_functions['texture.point_density.falloff'],  ''), 
        "texture.point_density.use_falloff_curve":(api_functions['texture.point_density.use_falloff_curve'],  ''), 
        "texture.point_density.vertex_cache_space":(api_functions['texture.point_density.vertex_cache_space'],  ''), 
        "texture.point_density.falloff_speed_scale":(api_functions['texture.point_density.falloff_speed_scale'],  ''),
        "texture.extension":(api_functions['texture.extension'],  ''), "texture.crop_min_x":(api_functions['texture.crop_min_x'],  ''), 
        "texture.crop_min_y":(api_functions['texture.crop_min_y'],  ''), "texture.crop_max_x":(api_functions['texture.crop_max_x'],  ''),
        "texture.crop_max_y":(api_functions['texture.crop_max_y'],  ''), "texture.repeat_x":(api_functions['texture.repeat_x'],  ''), 
        "texture.repeat_y":(api_functions['texture.repeat_y'],  ''), "texture.use_mirror_x":(api_functions['texture.use_mirror_x'],  ''),
        "texture.use_mirror_y":(api_functions['texture.use_mirror_y'],  ''), "texture.use_checker_even":(api_functions['texture.use_checker_even'],  ''), 
        "texture.use_checker_odd":(api_functions['texture.use_checker_odd'],  ''), "texture.checker_distance":(api_functions['texture.checker_distance'],  ''), 
        "texture.use_alpha":(api_functions['texture.use_alpha'],  ''), "texture.use_calculate_alpha":(api_functions['texture.use_calculate_alpha'],  ''), 
        "texture.invert_alpha":(api_functions['texture.invert_alpha'],  ''), "texture.use_flip_axis":(api_functions['texture.use_flip_axis'],  ''), 
        "texture.use_normal_map":(api_functions['texture.use_normal_map'],  ''),"texture.normal_map_space":(api_functions['texture.normal_map_space'],  ''), 
        "texture.use_derivative_map":(api_functions['texture.use_derivative_map'],  ''), "texture.use_mipmap":(api_functions['texture.use_mipmap'],  ''), 
        "texture.use_mipmap_gauss":(api_functions['texture.use_mipmap_gauss'],  ''), 
        "texture.use_interpolation":(api_functions['texture.use_interpolation'],  ''), "texture.filter_type":(api_functions['texture.filter_type'],  ''),
        "texture.filter_eccentricity":(api_functions['texture.filter_eccentricity'],  ''), "texture.filter_size":(api_functions['texture.filter_size'],  ''), 
        "texture.filter_probes":(api_functions['texture.filter_probes'],  ''), "texture.use_filter_size_min":(api_functions['texture.use_filter_size_min'],  ''), 
        "texture.image.source":(api_functions['texture.image.source'],  ''), "texture.image.generated_width":(api_functions['texture.image.generated_width'],  ''), 
        "texture.image.generated_height":(api_functions['texture.image.generated_height'],  ''), 
        "texture.image.generated_float":(api_functions['texture.image.generated_float'],  ''),
        "texture.image.generated_type":(api_functions['texture.image.generated_type'],  ''), 
        "texture.image.use_fields":(api_functions['texture.image.use_fields'],  ''), 
        "texture.image.use_premultiply":(api_functions['texture.image.use_premultiply'],  ''), 
        "texture.image.field_order":(api_functions['texture.image.field_order'],  ''), 
        "texture.image.frame_duration":(api_functions['texture.image.frame_duration'],  ''), 
        "texture.image.frame_start":(api_functions['texture.image.frame_start'],  ''), 
        "texture.image.frame_offset":(api_functions['texture.image.frame_offset'],  ''), 
        "texture.image.fields_per_frame":(api_functions['texture.image.fields_per_frame'],  ''), 
        "texture.image.use_auto_refresh":(api_functions['texture.image.use_auto_refresh'],  ''), 
        "texture.image.use_cyclic":(api_functions['texture.image.use_cyclic'],  ''), "texture.filter_type":(api_functions['texture.filter_type'],  ''), 
        "texture.filter_eccentricity":(api_functions['texture.filter_eccentricity'],  ''), "texture.filter_size":(api_functions['texture.filter_size'],  ''), 
        "texture.use_filter_size_min":(api_functions['texture.use_filter_size_min'],  ''), "texture.filter_probes":(api_functions['texture.filter_probes'],  ''), 
        "texture.environment_map.source":(api_functions['texture.environment_map.source'],  ''), 
        "texture.environment_map.zoom":(api_functions['texture.environment_map.zoom'],  ''), 
        "texture.environment_map.layers_ignore":(api_functions['texture.environment_map.layers_ignore'],  ''), 
        "texture.environment_map.resolution":(api_functions['texture.environment_map.resolution'],  ''), 
        "texture.environment_map.depth":(api_functions['texture.environment_map.depth'],  ''), 
        "texture.environment_map.clip_start":(api_functions['texture.environment_map.clip_start'],  ''), 
        "texture.environment_map.clip_end":(api_functions['texture.environment_map.clip_end'],  ''), 
        "texture.environment_map.mapping":(api_functions['texture.environment_map.mapping'],  ''),
        "texture.voxel_data.file_format":(api_functions['texture.voxel_data.file_format'],  ''), 
        "texture.voxel_data.intensity":(api_functions['texture.voxel_data.intensity'],  ''), 
        "texture.voxel_data.extension":(api_functions['texture.voxel_data.extension'],  ''), 
        "texture.voxel_data.interpolation":(api_functions['texture.voxel_data.interpolation'],  ''), 
        "texture.voxel_data.smoke_data_type":(api_functions['texture.voxel_data.smoke_data_type'],  ''), 
        "texture.voxel_data.filepath":(api_functions['texture.voxel_data.filepath'],  ''), 
        "texture.voxel_data.resolution":(api_functions['texture.voxel_data.resolution'],  ''), 
        "texture.voxel_data.use_still_frame":(api_functions['texture.voxel_data.use_still_frame'],  ''),
        "texture.voxel_data.still_frame":(api_functions['texture.voxel_data.still_frame'],  ''),}    

...
def TexturesSaveKeys():
    temp = \
        (
            "num_textures", "idx_materials", "idx_color_ramp",  "idx_point_density_ramp",  "name", "type", "use_textures", "texture_use_preview_alpha", 
         )
    return temp   
def TexturesOtherSaveKeys():
    temp = \
        (
            ...
            "uv_layer", "uv_layer_name",  "image_uv_blob", "texture_use_alpha", 
         )
    return temp 
